export default function Paddle({ icon, title, text }) {
  return (
    <div className='flex flex-col border-[1.5px] border-primary mv:w-full md:w-[320px] p-6 rounded-md paddle-card hover:shadow-btn hover:scale-102 ease-in duration-75'>
